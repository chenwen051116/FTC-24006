...
@Config
@Autonomous(name = "Blue_Near_Elims_gateOpen")
...
public class Blue_Near_18ball extends OpMode {
    ...
    private final Pose GatePrep2 = new Pose(116.5,-58.65,-0);
    private final Pose GatePush2 = new Pose(116.5,-58.65,-0);
    ...
    private final Pose PrepGather3 = new Pose(91.9908, -74.8070, 0);//accounted for overshoot
