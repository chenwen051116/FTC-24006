...
@Config
@Autonomous(name = "Blue_Near_18ball_gate")

public class Blue_Near_18ball extends OpMode {
    ...
    private final Pose GatePose = new Pose(124.7751, -50.42112, -0.4920);//pickup
    private final Pose ShootPose = new Pose(82.0559, -71.1033 ,-0.0053);
...
//        finishGatherPath2 = simplePath(PrepGather2, FinishGather2);
        ...
        Shootpath3 = drive.follower.pathBuilder()
                .addPath(new BezierCurve(FinishGather3, Park))
                .setLinearHeadingInterpolation(FinishGather3.getHeading(), Park.getHeading())
                .build();
