...
import org.firstinspires.ftc.teamcode.commands.IntakeNodisCommand;
...
@TeleOp
public class TeleOnedriver_Nodis extends CommandOpMode {
    private Drivetrain drivetrain;
    private Intake_NoDis intake;
    ...
    public void initialize() { //Init button on DriverHUB
        ...
        intake = new Intake_NoDis(hardwareMap);
        //intake.setSwingBarPos(0.4);
        intake.setDefaultCommand(new IntakeNodisCommand(gamepad1, intake));
