...
//        gamepadEx1.getGamepadButton(GamepadKeys.Button.DPAD_RIGHT).whenPressed(() -> limelight.initRedPipeline());
    ...
    public void run() {
        ...
        turret.baseHeading = drivetrain.compress(drivetrain.getHeading()+Math.PI);
...
//        telemetry.addData("turretpos", turret.getPos());
        telemetry.addData("turretaimangle", turret.aimangle);
        telemetry.addData("turretcalc aim", turret.calculateAim());
...
////        telemetry.addData("ShotterForce?", shooter.forceShooting);
      ...
      telemetry.addData("turretangle", turret.readAngle());
        telemetry.addData("turretodo", turret.getPos());
